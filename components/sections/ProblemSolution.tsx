    ...
    <SectionWrapper className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Problems */}
          <div className="rounded-2xl border border-red-500/10 bg-red-500/5 p-6 md:p-8 space-y-4">
            <h3 className="font-display font-bold text-xl text-slate-300 mb-2">
              Sekarang
            </h3>
            <ul className="space-y-3">
              {PROBLEMS.map((problem) => (
                <li key={problem.text} className="flex items-start gap-3 text-slate-400">
          ...
          {/* Solutions */}
          <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-6 md:p-8 space-y-4">
            <h3 className="font-display font-bold text-xl text-white mb-2">
              Dengan NuansaPos
            </h3>
            <ul className="space-y-3">
              {SOLUTIONS.map((solution) => (
                <li key={solution.text} className="flex items-start gap-3 text-slate-200">
